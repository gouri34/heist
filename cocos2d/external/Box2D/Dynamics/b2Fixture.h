...
public:
    ...
    const FixtureType GetFixtureType() const;
    void SetFixtureType(FixtureType t);
...
inline const FixtureType b2Fixture::GetFixtureType() const
{
    return m_fixturetype;
}

inline void b2Fixture::SetFixtureType(FixtureType t)
{
    m_fixturetype = t;
}
